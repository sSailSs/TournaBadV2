...
@section('content')
    <section class="hero">
        ...
        <p style="color: rgba(255,255,255,0.9); max-width: 780px; margin-bottom: 0;">
            ...
            Le 1v1 et les autres parametres restent disponibles pour preparer la structure, puis on activera la logique au fur et a mesure.
        </p>
    </section>

    <section class="grid grid-3 mode-grid" style="margin-top: 1rem;">
        <article class="card mode-card mode-card-disabled" style="border-top: 4px solid var(--accent); opacity: .72;">
            <h2>1 vs 1</h2>
            <p>Tournoi interne individuel. En cours de travaux.</p>
            <span class="badge">En cours de travaux</span>
        </article>
        ...
        <a class="card mode-card mode-card-active" href="{{ route('tournaments.create') }}" style="border-top: 4px solid var(--brand); text-decoration:none; color:inherit;">
            <h2>2 vs 2</h2>
            <p>C'est le mode actuellement implemente: creation du tournoi, joueurs, tirage, scores et points individuels.</p>
        ...
        <article class="card mode-card mode-card-disabled" style="border-top: 4px solid var(--muted); opacity: .72;">
            <h2>Autres parametres</h2>
            <p>Par exemple un tournoi interne par niveau, par categorie ou avec des regles specifiques.</p>
    ...
    <section class="grid grid-3" style="margin-top: 1rem;">
        ...
        <article class="card">
            ...
            <div class="list" style="margin-top:.45rem;">
                ...
                <a class="tag" href="{{ route('tournaments.create') }}">Creer un tournoi</a>
