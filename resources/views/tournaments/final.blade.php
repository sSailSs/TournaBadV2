            ...
            @foreach ($podiumOrder as $index)
                ...
                <article class="final-podium-card {{ $index === 0 ? 'final-podium-first' : '' }}">
                    ...
                    @else
                        ...
                        <p class="muted" style="margin:.25rem 0 0;">Aucun joueur</p>
                    @endif
                </article>
            @endforeach
        </div>
    ...
    <section class="grid grid-2" style="margin-top:1rem; align-items:start;">
        <article class="card">
            ...
            <ol class="final-list">
                ...
                @empty
                    <li class="final-list-item">
                        <span class="muted">Aucun autre joueur à classer.</span>
                    </li>
                @endforelse
            </ol>
        </article>
        ...
        <article class="card">
            ...
            <p><strong>{{ $players->count() }}</strong> joueur(s) classé(s)</p>
